...
module.exports = {
  ...
  variants: {
    ...
    gridAutoColumns: ['responsive', 'first'],
    gridAutoFlow: ['responsive', 'first'],
    gridAutoRows: ['responsive', 'first'],
    gridColumn: ['responsive', 'first'],
    gridColumnEnd: ['responsive', 'first'],
    gridColumnStart: ['responsive', 'first'],
    gridRow: ['responsive', 'first'],
    gridRowEnd: ['responsive', 'first'],
    gridRowStart: ['responsive', 'first'],
    gridTemplateColumns: ['responsive', 'first'],
    gridTemplateRows: ['responsive', 'first'],
